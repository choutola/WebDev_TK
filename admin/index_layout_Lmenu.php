<nav>
	<ul class="nav nav-pills nav-stacked">
		<li role="presentation" class="active actived"><a href="#"><span class="glyphicon glyphicon-file"></span>HomePage Editor</a></li>
	...
	<ul class="nav nav-pills nav-stacked">
		...
		<li><a href="account_info.php"><span class="glyphicon glyphicon-plus"></span>Add Product</a></li>
		<li><a href="account_info.php"><span class="glyphicon glyphicon-plus"></span>Manage Product</a></li>
	</ul>
	<ul class="nav nav-pills nav-stacked">
